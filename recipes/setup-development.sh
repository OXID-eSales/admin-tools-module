...
docker compose exec -T php composer require oxid-esales/apex-theme dev-b-7.4.x
docker compose exec -T php composer require oxid-esales/graphql-base dev-b-7.4.x
...
docker compose exec -T php vendor/bin/oe-console oe:module:activate oe_admintools
