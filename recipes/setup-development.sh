...
docker compose exec -T php composer require oxid-esales/apex-theme dev-b-7.5.x
docker compose exec -T php composer require oxid-esales/graphql-base dev-b-7.5.x
