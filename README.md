...
```bash
# Install desired version of oxid-esales/admin-tools for OXID 7.6.
composer require oxid-esales/admin-tools:dev-b-7.6.x
```
...
```bash
# Install and activate compatible version of oxid-esales/graphql-base for OXID 7.6.
#
composer require oxid-esales/graphql-base:dev-b-7.6.x
...
```shell
git clone --recurse-submodules https://github.com/OXID-eSales/admin-tools-module.git --branch=b-7.6.x ./source
```
